...
class AnnubesEnv(TrialEnv):
    ...
    Args:
        ...
        catch_prob: Probability of catch trials in the session. Must be between 0 and 1 (inclusive).
            Defaults to 0.5.
        max_sequential: Maximum number of sequential trials of the same modality. It applies only to the modalities defined
            in `session`, i.e., it does not apply to catch trials. 
