...
.. autoclass:: neurogym.envs.perceptualdecisionmaking.PulseDecisionMaking
    ...
    Supervised learning and analysis of this task
        `[Open in colab] <https://colab.research.google.com/github/neurogym/ngym_usage/blob/master/supervised/auto_notebooks/PulseDecisionMaking-v0.ipynb>`_
        `[Jupyter notebook Source] <https://github.com/neurogym/ngym_usage/blob/master/supervised/auto_notebooks/PulseDecisionMaking-v0.ipynb>`_
    Sample run
