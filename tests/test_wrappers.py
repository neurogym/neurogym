...
# Note: VariableMapping is not implemented in the current version of neurogym
...
# Note: TimeOut is not implemented in the current version of neurogym
# def test_timeout(
...
# Note: CatchTrials is not implemented in the current version of neurogym
...
# Note: TTLPulse is not implemented in the current version of neurogym
...
# Note: TransferLearning is not implemented in the current version of neurogym
...
# Note: Combine is not implemented in the current version of neurogym
...
# Note: Identity is not implemented in the current version of neurogym
...
# Note: TrialHistoryEvolution is not implemented in the current version of neurogym
