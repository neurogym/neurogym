...
# TODO: are these tests still useful for legacy purposes?
# ruff: noqa: F821, N803
...
def test_concat_wrpprs_th_vch_pssr_pssa(
    ...
    for _ in range(num_steps):
        ...
        if info["new_trial"] and verbose:
            ...
            blk_id, indx = _check_blk_id(blk_id, info["curr_block"], num_blocks)
...
def _check_blk_id(blk_id_mat, curr_blk, num_blk):
...
if __name__ == "__main__":
    ...
    # test_transferLearning(num_steps=200, verbose=True) # noqa: ERA001
